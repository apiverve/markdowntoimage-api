# Markdown to Image API - Examples

This folder contains example code for using the Markdown to Image API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/markdowntoimage',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/markdowntoimage");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/markdowntoimage](https://docs.apiverve.com/ref/markdowntoimage)
