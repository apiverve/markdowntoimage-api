...
const (
	baseURL        = "https://api.apiverve.com/v1/markdowntoimage"
	defaultTimeout = 30 * time.Second
)

// Client is the Markdown to Image API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Markdown to Image API client.
...
// Execute makes a request to the Markdown to Image API with typed parameters.
//
