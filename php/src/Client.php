...
namespace APIVerve\Markdowntoimage;
...
/**
 * Client for the Markdown to Image API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://markdowntoimage.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/markdowntoimage';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MarkdowntoimageClient] {$message}\n";
        }
    }
}
