...
class markdowntoimageWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/markdowntoimage');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/markdowntoimage';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"markdown":{"type":"string","required":true,"maxLength":500000},"width":{"type":"integer","required":false,"min":100,"max":3840,"default":1280},"height":{"type":"integer","required":false,"min":100,"max":2160,"default":800},"format":{"type":"string","required":false,"default":"png"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/markdowntoimage`);
        }
    }
...
module.exports = markdowntoimageWrapper;
