...
namespace APIVerve.API.MarkdowntoImage
{
    ...
    /// <summary>
    /// Client for the MarkdowntoImage API
    /// </summary>
    public class MarkdowntoImageAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/markdowntoimage";
        ...
        {
            { "markdown", new ValidationRule { Type = "string", Required = true, MaxLength = 500000 } },
        ...
        public MarkdowntoImageAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MarkdowntoImageAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MarkdowntoImageAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MarkdowntoImageQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MarkdowntoImageQueryOptions options)
        {
        ...
        public ResponseObj Execute(MarkdowntoImageQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MarkdowntoImageQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MarkdowntoImageQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MarkdowntoImageQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MarkdowntoImageQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MarkdowntoImageQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MarkdowntoImageQueryOptions options)
        {
