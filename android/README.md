...
```gradle
dependencies {
    implementation 'com.github.apiverve:markdowntoimage-api:1.1.12'
}
```
...
```java
import com.apiverve.markdowntoimage.MarkdowntoImageAPIClient;
import com.apiverve.markdowntoimage.APIResponse;
import com.apiverve.markdowntoimage.APIException;

// Initialize the client
MarkdowntoImageAPIClient client = new MarkdowntoImageAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/markdowntoimage](https://docs.apiverve.com/ref/markdowntoimage)
...
- **Documentation:** [https://docs.apiverve.com/ref/markdowntoimage](https://docs.apiverve.com/ref/markdowntoimage)
- **Issues:** [GitHub Issues](https://github.com/apiverve/markdowntoimage-api/issues)
