...
class TestMarkdowntoimageAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = MarkdowntoimageAPIClient(self.api_key)

    @patch('apiverve_markdowntoimage.apiClient.requests.get')
